...
class paf_processor_impl : public paf_processor
{
  public:
    paf_processor_impl(int input_height, int input_width, int height, int width,
        ...
        : height(height), width(width), input_height(input_height),
          input_width(input_width), n_joins(n_joins),
          n_connections(n_connections), upsample_conf(n_joins, height, width),
